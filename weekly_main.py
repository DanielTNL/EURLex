    ...
    steps:
      ...
      - name: Run weekly synthesis
        ...
        env:
          ...
          OPENAI_MODEL:             ${{ vars.OPENAI_WEEKLY_MODEL }}    # e.g. gpt-4o-mini or gpt-4o-mini-high
          OPENAI_TTS_MODEL:         ${{ vars.OPENAI_TTS_MODEL }}       # e.g. gpt-4o-mini-tts or tts-1
          OPENAI_TTS_VOICE:         ${{ vars.OPENAI_TTS_VOICE }}       # e.g. alloy

          # Gmail (optional mail notice)
          GMAIL_USER:               ${{ secrets.GMAIL_USER }}
          GMAIL_PASS:               ${{ secrets.GMAIL_PASS }}

          # Google OAuth (your Gmail account)
